...
function main()
    ...
    for classe in 1:Classes
        γ = -0.70 + (classe * (0.40 / Classes))  # mesmo cálculo do Gera_Mapas_Jorge.jl
        ...
        for k in 1:N_series_por_classe
            ...
            push!(resultados, (γ=γ, probs=probs))
        end
    end
...
output_file = "Data_Gauss_RM_40classes_2.dat"
open(output_file, "w") do io
    for r in resultados
        linha = join([r.γ; r.probs], " ")
        write(io, linha * "\n")
    end
end
