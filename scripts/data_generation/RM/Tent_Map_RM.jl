...
function main()
    ...
    for classe in 1:Classes
        μ = 1.80 + (classe * (0.19999 / Classes))  # mesmo cálculo do Gera_Mapas_Jorge.jl
        ...
        for k in 1:N_series_por_classe
            ...
            push!(resultados, (μ=μ, probs=probs))
        end
    end
...
output_file = "Data_Tent_RM_40classes_4.dat"
open(output_file, "w") do io
    for r in resultados
        linha = join([r.μ; r.probs], " ")
        write(io, linha * "\n")
    end
end
