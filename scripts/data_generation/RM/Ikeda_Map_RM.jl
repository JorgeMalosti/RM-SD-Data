...
function main()
    ...
    for classe in 1:Classes
        u = 0.6 + (classe * (0.29999 / Classes))  # mesmo cálculo do Gera_Mapas_Jorge.jl
        ...
        for k in 1:N_series_por_classe
            ...
            push!(resultados, (u=u, probs=probs))
        end
    end
...
output_file = "Data_Ikeda_RM_40classes_1.dat"
open(output_file, "w") do io
    for r in resultados
        linha = join([r.u; r.probs], " ")
        write(io, linha * "\n")
    end
end
